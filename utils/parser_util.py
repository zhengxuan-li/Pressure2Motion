...
def add_base_options(parser):
    ...
    group.add_argument('--local_rank', type=int, default=-1, help='Local rank of the process for distributed training')
    group.add_argument("--gpu_id", type=int, nargs='+', default=(-1), help='GPU id')
    group.add_argument("--distributed", action="store_true", help='Whether to use DDP training')
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='mpl', choices=['humanml', 'kit', 'humanact12', 'uestc', 'mpl'], type=str,
...
def add_generate_options(parser):
    ...
    group.add_argument("--file_name", default='000000', type=str)
    group.add_argument("--data_path", default='./datasets/MPL', type=str)
...
def add_evaluation_options(parser):
    ...
    group.add_argument("--model_path", required=True, type=str,
                       help="Path to model####.pt file to be sampled.")
    group.add_argument("--eval_mode", default='control', choices=['control'], type=str,
                       help="")
    group.add_argument("--guidance_param", default=2.5, type=float,
                       help="For classifier-free sampling - specifies the s parameter, as defined in the paper.")
